...
namespace SAMvc.Models
{
    ...
    {
        //MVC FluentValidation NuGet package
        public int Id { get; set; }

        //[Required(ErrorMessage ="Name must not ne empty!")]
        [Required(ErrorMessage = "{0} must not ne empty!")]
        ...
        public string ReviewsText 
        {
            get 
            {
                ...
                if (Reviews != null && Reviews.Count > 0)
                    foreach (ReviewModel reviewModel in Reviews)
                        _reviews += reviewModel.Content + "<hr />";
                return _reviews;
            }
        }
    }
